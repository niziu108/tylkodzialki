...
// P24: mapa raportu — obrys działki (z ULDK, WGS84). Domyślnie zwykła mapa (roadmap), a nie zdjęcie
// satelitarne; podgląd z satelity pod dyskretnym przełącznikiem. Reuse jedynej ładowarki Google Maps.
