...
export default function ArticleCardCover({
  ...
  return (
    <div
      className={`relative flex aspect-[16/10] items-center justify-center overflow-hidden bg-[#131313] ${className}`}
    >
      ...
      <span className="relative text-sm font-medium tracking-wide text-white/45">
        tylkodzialki.pl
      </span>
    </div>
  );
