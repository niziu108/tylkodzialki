...
- **AKTUALNY PUNKT: P4** (artykuły bloga do sitemap — `app/sitemap.ts` + `prisma.article.findMany` → wpisy `/blog/[slug]`; SEO: indeksacja treści bloga w Google). **Sprint HERO (czytelność) zrobiony poza kolejnością 2026-06-16 — wracamy do P4.**
