...
- **AKTUALNY PUNKT: P5** (desktopowy „Napisz" — załatać **jedyną realną lukę kontaktu**: na desktopie przycisk, który i tak wysyła wiadomość na telefon/mail sprzedawcy; filozofia zachowana, bezpośrednio podbija „więcej kontaktów"). Rekomendacja oparta o ujawnioną preferencję właściciela (wybrał feature P8 ponad szybką wygraną P4b → chce dźwigni o dużym wpływie). Alternatywy o wysokim priorytecie, gdyby właściciel chciał inaczej: **P6** (alerty e-mail — silnik powrotów) oraz niedokończone **P4b** (linkowanie do bloga). Poprzedni: **P8 ✅** (podobne oferty — rail na dole każdej oferty, 8 najbliższych, SSR/SEO; właściciel świadomie przeskoczył P4b→P8).
