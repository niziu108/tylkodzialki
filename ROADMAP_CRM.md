...
### P-N: Sprzedane oferty Galactiki nie znikały — `<oferta_usun>` szło do kosza [NAPRAWIONE i WDROŻONE 2026-08-17]
...
- **Wynik na produkcji (2026-08-17):** backfill w trzech etapach wygasił **604 oferty**, zero wróciło (REACTIVATE), zero linków w stanie pośrednim. Aktywne oferty Galactiki: 3250 → 2646. Najmocniej biura, które od dawna nic nie wycofywały (40%, 30%, 29% podaży).
...
- **Naprawa:**
  ...
  3. Bez pętli: decyzja zapada przed wgraniem, na liście plików z FTP albo ZIP-a, więc trwale brakujący plik nie powoduje wgrywania w każdym przebiegu. `CrmOfferLink.externalUpdatedAt` zapisujemy wyłącznie przy galerii zgodnej z feedem, żeby zostawiona galeria wymieniła się, gdy brakujący plik dotrze. Skutek dla innych reguł czytających tę datę (np. pomijanie starszych wersji oferty): bywa starsza niż zapisane dane oferty, nigdy nowsza, więc nie blokuje fałszywie, a przy niezgodnej galerii chroni od daty ostatniej zgodnej.
