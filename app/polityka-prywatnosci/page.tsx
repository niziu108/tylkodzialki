      ...
      <div className="mx-auto max-w-5xl px-5 pb-24 pt-16 sm:px-6 lg:px-8 lg:pt-20">
        <div className="mb-12 space-y-5 border-b border-fg/10 pb-8">
          ...
          <div className="rounded-3xl border border-fg/10 bg-fg/[0.03] p-5 text-sm leading-7 text-fg/70">
            <p>
              <span className="text-fg">Administrator danych:</span> Ultima Reality Sp. z o.o.
            </p>
            <p>
        ...
        <div className="mb-12 grid gap-3 rounded-3xl border border-fg/10 bg-fg/[0.02] p-5 text-sm text-fg/70 sm:grid-cols-2">
          ...
          <Link href="#zakres" className="transition hover:text-fg">
            §2. Zakres przetwarzanych danych
          </Link>
          <Link href="#cele" className="transition hover:text-fg">
            §3. Cele i podstawy prawne
          </Link>
          <Link href="#odbiorcy" className="transition hover:text-fg">
            §4. Odbiorcy danych
          </Link>
          <Link href="#okres" className="transition hover:text-fg">
            §5. Okres przechowywania danych
          </Link>
          <Link href="#prawa" className="transition hover:text-fg">
            §6. Prawa użytkownika
          </Link>
          <Link href="#dobrowolnosc" className="transition hover:text-fg">
            §7. Dobrowolność podania danych
          </Link>
          <Link href="#bezpieczenstwo" className="transition hover:text-fg">
            §8. Bezpieczeństwo danych
          </Link>
          <Link href="#kontakt" className="transition hover:text-fg">
