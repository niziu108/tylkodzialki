        ...
        <div>
          ...
          <div className="rounded-2xl border border-fg/10 bg-surface p-3">
            {imageUrl ? (
              ...
              <div className="flex h-44 items-center justify-center rounded-2xl border border-dashed border-fg/10 bg-surface text-sm text-fg/70">
...
`}
            className="w-full rounded-2xl border border-fg/10 bg-surface px-4 py-3 text-sm leading-7 text-fg outline-none transition placeholder:text-fg/70 focus:border-brand/60"
            required
          />
          <p className="mt-2 text-xs text-fg/70">
          ...
          <div className="mt-4 grid gap-4">
            <div>
              <div className="mb-2 flex items-center justify-between">
                ...
                <span
                  className={`text-xs ${seoTitleLen > 60 ? 'text-amber-300' : 'text-fg/70'}`}
                >
                  {seoTitleLen}/60
                </span>
              </div>
            ...
            <div>
              <div className="mb-2 flex items-center justify-between">
                ...
                <span
                  className={`text-xs ${seoDescLen > 160 ? 'text-amber-300' : 'text-fg/70'}`}
                >
                  {seoDescLen}/160
                </span>
              </div>
      ...
      <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex flex-col gap-2 text-xs text-fg/70 sm:text-sm">
