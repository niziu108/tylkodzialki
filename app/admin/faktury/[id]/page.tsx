...
function getBuyerTypeBadgeClass(buyerType?: InvoiceBuyerType | null) {
  switch (buyerType) {
    ...
    case "PRIVATE":
      return "bg-fg/10 text-fg/80 border border-fg/10";
    default:
      return "bg-fg/5 text-fg/70 border border-fg/10";
  }
}
...
function DetailItem({
  ...
  return (
    <div className="rounded-2xl border border-fg/10 bg-surface p-4">
      <div className="mb-1 text-xs uppercase tracking-wide text-fg/70">
        {label}
      </div>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <section className="mb-6 rounded-3xl border border-fg/10 bg-fg/5 p-5">
          <div className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
              <div className="text-sm text-fg/70">Numer faktury</div>
        ...
        <div className="mb-6 grid gap-6 xl:grid-cols-2">
          <section className="rounded-3xl border border-fg/10 bg-fg/5 p-5">
            ...
            <div className="mt-4 rounded-2xl border border-fg/10 bg-surface p-4">
              <div className="mb-2 text-xs uppercase tracking-wide text-fg/70">
