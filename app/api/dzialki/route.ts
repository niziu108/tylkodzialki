...
export async function GET(req: Request) {
  ...
  // Cała logika listy/mapy żyje w src/lib/dzialkiListing.ts — współdzielona z SSR strony /kup,
  // żeby wyniki z tego API i z renderu serwerowego były identyczne (jedno źródło prawdy).
  const body = await queryDzialkiList(url.searchParams);
